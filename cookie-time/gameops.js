...
com.funtomic.GameOps.sendRequest = function (url, params, onSuccess, onStatus, onError, isPost) {
...
com.funtomic.GameOps.loadGameConfig = function (gameState, callback) {
    ...
    if (com.funtomic.GameOps.localStorage.configMd5 != null) params.config_md5 = com.funtomic.GameOps.localStorage.configMd5;
...
com.funtomic.GameOps.afterInit = function () {
    ...
    try {
        if (com.funtomic.GameOps.gameConfig.eval_on_after_init != null && com.funtomic.GameOps.gameConfig.eval_on_after_init != "") {
            window.evalInContext = function (js, context) {
                return function () {
                    return eval(js);
                }.call(context);
            }
...
com.funtomic.GameOps.reportEvent = function (eventType, params) {
    if (com.funtomic.GameOps.isEventsTraceOnly) {
        haxe.Log.trace(eventType, { fileName: "GameOps.hx", lineNumber: 591, className: "com.funtomic.GameOps", methodName: "reportEvent", customParams: [params]});
        return;
    }
...
com.funtomic.GameOps.getUserOS = function () {
    if (new EReg("(Android)", "i").match(window.navigator.userAgent)) return "android"; else if (new EReg("(iPad|iPhone|iPod)", "i").match(window.navigator.userAgent)) return "ios"; else return "other";
};
...
com.funtomic.GameOps.gameOpsVersion = "0.7.4";
