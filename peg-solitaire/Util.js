...
Util.getDirectionBetweenCells = function(cell1, cell2)
{
  var i = cell2.i - cell1.i;
  var j = cell2.j - cell1.j;

  if(i > 0 && j == 0) return 'right';
  else if(i < 0 && j == 0) return 'left';
  else if(j < 0 && i == 0) return 'up';
  else if(j > 0 && i == 0) return 'down';
...
Util.getDirectionBetweenHexs = function(hex1, hex2)
{
  ...
  else if(i > 0 && j > 0) return 'down_right';
  else if(i > 0 && j < 0) return 'up_right';
  else if(i < 0 && j > 0) return 'down_left';
  else if(i < 0 && j < 0) return 'up_left';
